...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-gradient-to-r from-white/40 to-blue-50/40 dark:from-gray-900/60 dark:to-blue-950/60 backdrop-blur-md shadow-sm z-50 border-b border-blue-100/50 dark:border-blue-900/50 transition-all duration-300">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        {/* Linha com logo e botão de tema - centralizada */}
