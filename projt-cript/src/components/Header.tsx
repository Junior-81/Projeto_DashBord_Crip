...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-gradient-to-r from-white/90 to-blue-50/90 dark:from-gray-900/95 dark:to-blue-950/95 backdrop-blur-md shadow-lg z-50 border-b border-blue-100 dark:border-blue-900">
